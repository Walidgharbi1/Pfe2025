    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <section className="text-center py-16 px-4">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Notre application vous permet de gérer efficacement les candidatures,
          d'analyser les CV et d'attribuer des tests techniques spécifiques.
        </p>
      </section>
      ...
      <section className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 px-4">
        <div className="bg-white shadow rounded-xl p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Consultez nos offres d'emploi et de stage disponibles.
          </p>
          <Link
            to="api/offres/offres"
        ...
        <div className="bg-white shadow rounded-xl p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Gérez votre profil, vos candidatures et passez des tests.
          </p>
          <Link
            to="/Connexion"
        ...
        <div className="bg-white shadow rounded-xl p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Restez informé des dernières actualités de notre entreprise.
          </p>
          <Link
            to="/actualites"
          ...
          {[
            {
              ...
              text: "Inscrivez-vous et complétez votre profil avec vos compétences.",
            },
            {
              step: "2",
              title: "Consultez les offres",
              text: "Parcourez nos offres d'emploi et de stage disponibles.",
            },
            {
              step: "3",
              title: "Postulez en ligne",
              text: "Soumettez votre candidature et votre lettre de motivation.",
            },
            {
              step: "4",
              title: "Passez les tests",
              text: "Démontrez vos compétences à travers nos tests techniques.",
            },
          ].map(({ step, title, text }) => (
            <div key={step}>
